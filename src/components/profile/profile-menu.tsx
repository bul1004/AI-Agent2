                ...
                {currentOrg ? (
                  <>
                    ...
                    <div className="flex-1 text-left min-w-0">
                      <div className="font-semibold text-base truncate">{currentOrg.name}</div>
                      ...
                      <div className="p-2">
                        ...
                        >
                          ...
                          <div className="flex-1 text-left min-w-0">
                            ...
                            <div className="text-xs text-muted-foreground">個人</div>
                          </div>
                          {!currentOrg && (
                        ...
                        >
                          ...
                          <div className="text-sm font-medium">チームを作成</div>
                        </button>
                      </div>
                    </div>
                  </div>
